...
//--------------------------------------------------------------------------------//
import HyperAaugeI from "../usersscreens/Aauge/HyperglycemiaAauge";
import HypoAaugeI from "../usersscreens/Aauge/HypoglycemiaAauge";
import Sugargrade from "../usersscreens/SugarGrade";
import Chatusers from "../usersscreens/Chatusers";
import Graph from "../usersscreens/Graph";
import Alarmmain from '../Alarm/Alarmmain';
import Proflie from '../usersscreens/Proflie';
import GaugeHistory from '../usersscreens/MedicalHistory/GaugeHistory';
  ...
  const handleItemClick = async (item) => {
    try {
      ...
      if (userData) {
        ...
        navigation.navigate(item.component, { userId });
      } else {
